<?php
    $titulo = "Painel Super Admin - GEIPE";
    $css = "admin/index.css";
    $paginaAtiva = "inicio";
...
<section class="admin-painel">
    <h1>Bem-vindo ao painel de administração do SuperAdmin, <?= $_SESSION['utilizador'] ?></h1>
    ...
    <div class="cards-admin">
        ...
        <div class="card-admin">
            ...
            <h3>Estágios</h3>
            <p>Gerir vagas de estágios</p>
            <a href="estagios.php">Ver</a>
        </div>

        <div class="card-admin">
            <i class="fa-solid fa-circle-question"></i>
            <h3>Perguntas FAQ</h3>
            <p>Gerir perguntas frequentes</p>
            <a href="perguntas.php">Ver</a>
        </div>
    </div>
</section>
