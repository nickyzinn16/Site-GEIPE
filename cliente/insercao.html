<html>
    <head>
        <meta charset="utf-8">
        <title>Inserção Profissional - GEIPE</title>
        ...
        <link rel="stylesheet" href="../styles/cliente/insercao.css">
                ...
                <nav class="navbar">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="insercao.html" class="ativo">Inserção Profissional</a></li>
